...
description: Learn how to use product attributes and slots in Adobe Commerce Edge Delivery Services to display delivery timelines, sale notices, and cart discounts.
...
* Merchandisers who want to understand what options are available using native features to enhance the customer experience.

## Video content

* Customize product detail and display customized delivery timelines for back-order products in the shopping cart.
* Returnable and Final Sale Information examples using standard functionality for the cart items.
