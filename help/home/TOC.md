...
+ Extensibility {#extensibility}
    ...
    + Adobe Developer App Builder {#adobe-developer-app-builder}
        ...
        + Use AI tools to create split payment POC {#create-a-split-payment-poc}
            ...
            + [Split payment POC: environment variables reference](../app-builder/split-payment-ai-tools/split-payment-poc-env-reference.md)
            ...
            + [Split payment POC: Experience Cloud UI extension AI prompt](../app-builder/split-payment-ai-tools/split-payment-poc-experience-cloud-ui-prompt.md)
